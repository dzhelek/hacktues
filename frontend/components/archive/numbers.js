    ...
    return(
        <Box>
            <SimpleGrid columns="3">
                <Box><Text textAlign="center" top="50%" left="50%" color="black" fontWeight="semibold" as="h1" lineHeight="tight">{props.allParticipants}</Text></Box>
                <Box><Text textAlign="center" top="50%" left="50%" color="black" fontWeight="semibold" as="h1" lineHeight="tight">{props.teams}</Text></Box>
                <Box><Text textAlign="center" top="50%" left="50%" color="black" fontWeight="semibold" as="h1" lineHeight="tight">{props.valuedProjects}</Text></Box>
