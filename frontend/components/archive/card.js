    ...
    return (
      <Flex flexDirection="column" flexWrap="wrap" alignSelf="stretch" flex="1 1" h="auto" m="15px" padding="15px" backgroundColor={color} rounded="lg" overflow="hidden">
        ...
        <Flex paddingTop={["10px","10px","10px","25px"]} justifyContent="center" flexDirection="column">
            <Text wordBreak="break-word" m="0" pt={["0","0","0","15px"]} fontWeight="300" as="h3"><strong>Участници: </strong>{props.teammates}</Text>
            <Text wordBreak="break-word" m="0" pt={["5px","5px","10px","15px"]} fontWeight="300" as="h3"><strong>Проект: </strong>{props.project}</Text>
        </Flex>
      </Flex>
    );
}
